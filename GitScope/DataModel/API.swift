...
public final class GetUserQlQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct User: GraphQLSelectionSet {
      ...
      public init(login: String, repositories: Repository, avatarUrl: String) {
        self.init(unsafeResultMap: ["__typename": "User", "login": login, "repositories": repositories.resultMap, "avatarUrl": avatarUrl])
      }
