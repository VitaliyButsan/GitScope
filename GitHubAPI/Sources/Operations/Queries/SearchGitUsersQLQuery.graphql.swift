...
public class SearchGitUsersQLQuery: GraphQLQuery {
  public static let operationName: String = "SearchGitUsersQL"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query SearchGitUsersQL($withName: String!) { search(first: 20, query: $withName, type: USER) { __typename nodes { __typename ...UserDetail } } rateLimit { __typename limit cost nodeCount remaining resetAt } }"#,
    ...
    public struct Search: GitHubAPI.SelectionSet {
      ...
      public struct Node: GitHubAPI.SelectionSet {
        ...
        public struct AsUser: GitHubAPI.InlineFragment {
          ...
          public typealias RootEntityType = SearchGitUsersQLQuery.Data.Search.Node
          ...
          public typealias Repositories = UserDetail.Repositories
        }
      }
    }
